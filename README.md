...
![Screenshot 2023-10-12 at 14 53 19](https://github.com/jelockwood/Super-Glue4/assets/4300786/3fbc8391-3ebf-4969-a8eb-2e847ef10c5e)
(The above shows the commandline parameters I use in my Super-Glue Jamf policy with my values redacted.)
...
(The above shows the triggers for my Super-Glue jamf policy, in my case it is triggered by my macOSLAPS policy each time the macOSLAPS policy runs - see below, if however you are not using a LAPS solution then you might instead run this once only on a checkin.)
...
(The above shows how my macOSLAPS policy triggers my Super-Glue policy.)
